...
export const recipeStepExamples: RecipeStep[] = [
    {
        ...
        recipe_id: "7A8D4757-0249-4372-8FA2-B245C6438446",
        num_step: 1,
        description: "Разогреть духовку до 180 градусов. Изюм и грецкие орехи мелко порубить.",
    ...
    },
    {
        ...
        recipe_id: "7A8D4757-0249-4372-8FA2-B245C6438446",
        num_step: 3,
        description: "В небольшом ковшике подогреть сок одного лимона, цедру половины лимона, мед, корицу и натертый имбирь.",
    ...
    },
    {
        ...
        recipe_id: "7A8D4757-0249-4372-8FA2-B245C6438446",
        num_step: 4,
        description: "В миску насыпать овсянку, орехи, изюм, кунжут, добавить растительное масло, муку и подогретый сироп из меда, лимонного сока и специй. Замесить тесто. Овсянку лучше брать самую мелкую, «Экстра» — ту, что варить надо минуты три, не дольше.",
    ...
    },
    {
        ...
        recipe_id: "7A8D4757-0249-4372-8FA2-B245C6438446",
        num_step: 5,
        description: "Затем столовой ложкой или руками сформировать печенья и уложить на противень, предварительно проложив его бумагой для запекания.",
    ...
    },
    {
        ...
        recipe_id: "7A8D4757-0249-4372-8FA2-B245C6438446",
        num_step: 6,
        description: "Выпекать примерно пятнадцать минут. Перед подачей дать печеньям остыть и подсохнуть.",
...

    {
        ...
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 1,
        description: "Мясо нарезать небольшими кубиками, поставить кастрюлю с водой и мясом на огонь.",
    },
    {
    ...
    },
    {
        ...
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 4,
        description: "Когда в кастрюле с мясом появится пенка, выловить из кастрюли мясо и вылить бульон. Вымыть кастрюлю от оставшейся пенки, налить в нее воды, поставить на огонь.",
    },
    {
        id: "44c5009c-2478-4b7c-a5dd-2b37b1be5ed3",
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 5,
        description: "Если вода в кастрюле закипела, то вымыть мясо и добавить в кастрюлю.",
    },
    {
    ...
    },
    {
        ...
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 9,
        description: "Натертую свеклу положить в разогретую сковороду с растительным маслом. Немного пожарить, налить 2 стакана бульона из кастрюли. Добавить чайную ложечку уксуса. Тушить пятнадцать-двадцать минут, периодически помешивая.",
    },
    {
        id: "88d9b0ee-8ddb-4fd2-bf69-8102536deb16",
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 10,
        description: "В кастрюлю добавить подготовленный картофель, через пять минут добавить капусту.",
    },
    {
        id: "4cae6293-c87c-4cf0-bb64-b029b9619a94",
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 11,
        description: "Разогреть сковороду с растительным маслом, пожарить лук, потом добавить морковь, немного пожарить. Налить стакан горячей воды. Тушить пять минут.",
    },
    {
        id: "b183905e-3ccd-40f3-a430-78028a3f6489",
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 12,
        description: "Тушеную свеклу положить в кастрюлю, потом овощи. Добавить специи (лавровый лист, черный молотый перец, острый молотый перец чили, соль) по вкусу.",
    },
    {
    ...
    },
    {
        ...
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 16,
        description: "Когда борщ будет готов, выключить огонь и дать настояться десять-пятнадцать минут.",
    },
    {
        id: "d6d323d1-d4bd-4b53-a22c-f0dbfeceb541",
        recipe_id: "18795A94-34A9-481C-ABBE-B1CC021E0820",
        num_step: 17,
        description: "Разлить по тарелкам, полить сметаной и посыпать рубленой зеленью.",
    },
    ...
    },
    {
        ...
        recipe_id: "37CA8D6E-FBBF-453F-9B2C-3F9E0CE1210E",
        num_step: 2,
        description: "В другой миске приготовьте соус: смешайте майонез, греческий йогурт, чеснок, лимонный сок и соль. Добавьте приправы по вкусу.",
    ...
    },
    {
        ...
        recipe_id: "37CA8D6E-FBBF-453F-9B2C-3F9E0CE1210E",
        num_step: 3,
        description: "Разогрейте гриль или сковороду на среднем огне. Готовьте мясо, периодически переворачивая, пока оно полностью не прожарится и не подрумянится — на это уйдет 5–7 минут. Снимите готовую курицу с огня и отложите ее в сторону.",
    ...
    },
    {
        ...
        recipe_id: "37CA8D6E-FBBF-453F-9B2C-3F9E0CE1210E",
        num_step: 4,
        description: "Нарежьте помидоры, огурцы и лук тонкой соломкой. Разогрейте лаваш на сухой сковороде или на гриле в течение 30 секунд с каждой стороны. Намажьте соус на лаваш, а затем выложите на него овощи и курицу.",
