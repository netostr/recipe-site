...
import { checkUserExistence, regisration, StateEmail } from "@/app/_lib/actions";
...
export default function SignupForm({ className }: {
    ...
    const [state, formAction, isPending] = useActionState(regisration, initialState);
    const [stateEmail, formActionEmail, isPendingEmail] = useActionState(checkUserExistence, initialStateEmail);
    ...
    return (
        ...
        >
            ...
            <CustomInput
                ...
                onBlur={(e) => prevEmail.current != e.target.value && startTransition(() => formActionEmail(e.target.value))}
            ...
            <CustomInput
                ...
                isPending={isPending}
            />
            <CustomButton type="submit" disabled={!!stateEmail.errors?.email || isPending}>
                {
